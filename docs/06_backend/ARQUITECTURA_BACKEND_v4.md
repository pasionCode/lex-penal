...
- `docs/00_gobierno/adrs/ADR-007-estrategia-autenticacion.md`
- `docs/00_gobierno/adrs/ADR-008-convencion-de-idioma-del-sistema.md`
...
| Motor de migraciones | Prisma Migrate |
| Base de datos | PostgreSQL 16 (ADR-002) |
| Autenticación | JWT simple — token único de 8h, cookie HttpOnly + Bearer (ADR-007). Sin refresh token en MVP. |
